...
import exhautsedKibby from "../images/exhausted-kibby.png";
...
const PlayError: Component = () => {
    ...
    return (
        <main class="min-h-dvh bg-orange-50 flex items-center justify-center px-6 py-12">
            <div class="w-full max-w-md flex flex-col items-center text-center">
                ...
                <div
                    ...
                    aria-hidden="true"
                >
                    <img src={exhautsedKibby} alt="Exhausted Kibby" />
                </div>

                <h1 class="text-3xl md:text-4xl font-semibold text-slate-700 tracking-wide">
                    Oops!
                </h1>

                <p class="mt-3 text-xl md:text-2xl text-slate-600 tracking-wide">
                    Failed to load your game
                </p>

                <p class="mt-2 max-w-xs text-sm md:text-base text-slate-400">
